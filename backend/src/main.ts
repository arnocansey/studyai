    ...
    const config = new DocumentBuilder()
      ...
      .setDescription(
        "StudyAI is an AI-powered adaptive learning platform with gamification, collaborative tools, real-time video sessions, and intelligent tutoring.\n\n" +
          ...
          "- **Notifications** – Push notification subscriptions and delivery (BullMQ)\n" +
      ...
      .addTag(
        "Lessons",
        "Lesson content, quiz verification, and lab submissions",
      )
      .addTag("Quiz", "Adaptive quizzing engine")
      .addTag(
        "Gamification",
        "XP, streaks, achievements, leaderboards, and study sessions",
      )
      .addTag(
        "AI",
        "Socratic tutor, concept explanations, code review, and hints",
      )
      ...
      .addTag(
        "Analytics",
        "Study analytics, heatmaps, predictions, and insights",
      )
      .addTag("Ops", "Instructor/admin operations summary and audit logs")
      .build();
