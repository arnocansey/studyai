    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Badge style={{ paddingHorizontal: 14, paddingVertical: 8 }}>
        ...
        <Card style={styles.leagueCard}>
          <View style={styles.leagueHeader}>
            ...
            <View style={styles.leagueInfo}>
              ...
              {nextLeague && (
                <Text
                  style={[styles.leagueNext, { color: colors.mutedForeground }]}
                >
                  {(nextLeague.minXP - userXP).toLocaleString()} XP to{" "}
                  {nextLeague.name}
                </Text>
              )}
            </View>
          ...
          <View
            style={[styles.leagueBarBg, { backgroundColor: colors.border }]}
          >
            <View
              style={[
        ...
        {activeTab === "leagues" && (
          <LeaguesView colors={colors} currentLeagueName={currentLeague.name} />
        )}
